...
public class PublicEventsScreen extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        Log.d("onCreate", "creation of PublicEventsScreen");
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_publicevents);
        setTitle("אירועיים ציבוריים"); //Change title
        forceRTLIfSupported();
